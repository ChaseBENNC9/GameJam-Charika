...
public class CameraFollow : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        transform.position = new Vector3(Player.transform.position.x + offset.x, this.transform.position.y , this.transform.position.z); //sets the camera to follow the player    
    }
}
